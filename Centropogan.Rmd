...
museum.data <-read.csv("Centropogon-hummer_data.csv")
```
...
plot.4 <-ggplot(flow.data, aes(x = exp.culmen.length, y = anther, color = b.species))+
  ...
  AsiaTheme+
   ...
   scale_color_viridis_d(breaks=c("Panterpe insignis", "Colibri cyanotus", "Eugenes spectabilis"))
plot.4
...
ggsave("Anther length cor plot.png", plot.5, width = 7, height = 5, units = "in")
```
...
plot.7 <-ggplot(flow.data, aes(x = tot.culmen.length, y = corolla, color = b.species))+
  ...
  AsiaTheme+
   ...
   theme(legend.position="top",
    ...
    scale_color_viridis_d(breaks=c("Panterpe insignis", "Colibri cyanotus", "Eugenes spectabilis"))
plot.7
ggsave("Corolla length cor plot.png", plot.7, width = 7, height = 5, units = "in")
```
...
ggsave("Corrolla length ci plot.png", corolla.ci.plot, width = 7, height = 5, units = "in")
ggsave("Anther length ci plot.png", anther.ci.plot, width = 7, height = 5, units = "in")
