...
```{r}
flow.data <- read.csv("data/Centropogan Data - Flower.csv", header = TRUE, na.strings = c(""," ","NA")) #Load in the data
str(flow.data) #Look at the structure of the data

cam.data <- read.csv("data/Centropogan Data - Camera.csv", header = TRUE, na.strings = c(""," ","NA"))
str(cam.data)

bird.data <-read.csv("data/Centropogan Data - Bird.csv", header = TRUE, na.strings = c(""," ","NA"))
str(bird.data)
